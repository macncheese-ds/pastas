  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={t('viscosityModal.title')} size="lg">
      <div className="space-y-6">
        ...
        {isInherited && (
          <div className="rounded-lg bg-deadtimes-card border border-blue-600 p-4">
            <div className="flex items-start">
              <InformationCircleIcon className="h-5 w-5 text-zinc-400 mr-2 mt-0.5 flex-shrink-0" />
              <div>
            ...
            <div className="mt-4 flex items-center justify-center">
              <div className="text-center">
                <p className="text-xs text-zinc-400 mb-1">{t('viscosityModal.measuredValue')}</p>
                <p className="text-4xl font-bold text-zinc-400">{inheritedValue}</p>
            ...
            <div className="flex items-center justify-center">
              <div className="text-center">
                <div className="flex items-center justify-center mb-2">
                  <BeakerIcon className="h-8 w-8 text-zinc-400" />
                </div>
        ...
        <div className="flex justify-end space-x-3 pt-4 border-t border-neutral-700">
          ...
          <button
            ...
            className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-deadtimes-card border border-deadtimes-border border border-transparent rounded-md shadow-sm hover:bg-deadtimes-hover focus:outline-none focus:ring-2 focus:ring-green-500 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading ? (
              <>
