      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-center space-x-4">
          ...
          <div className="text-center">
            ...
            <span className="inline-flex items-center rounded-full bg-deadtimes-card px-2.5 py-1 text-sm font-medium text-zinc-400">
        ...
        <div className="flex justify-end space-x-3 pt-4 border-t border-neutral-700">
          ...
          <button
            onClick={onConfirm}
            disabled={isLoading}
            className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md shadow-sm hover:bg-deadtimes-hover focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
          >
            {isLoading ? (
              <>
