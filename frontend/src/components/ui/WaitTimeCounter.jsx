...
export default function WaitTimeCounter({ fridgeOutDatetime, compact = false }) {
  ...
  return (
    <div className="inline-flex items-center space-x-2 px-3 py-1.5 rounded-lg bg-deadtimes-card">
      {timeRemaining.completed ? (
        <>
        ...
        <>
          ...
          <div className="flex flex-col">
            <span className="text-xs text-zinc-400">{t('waitTime.remaining')}:</span>
