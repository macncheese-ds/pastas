...
const TAB_COLORS = {
  blue: {
    ...
    inactive: 'border-transparent text-blue-300/40 hover:text-blue-300/70 hover:border-blue-800/50',
          ...
          {TABS.map((tab) => {
            ...
            return (
              ...
              >
                {tab.label}
                {count > 0 && (
                  <span className={`ml-2 py-0.5 px-2 rounded-full text-xs font-medium ${isActive ? colors.badge : 'bg-blue-950/50 text-blue-300/40'}`}>
                    {count}
                  </span>
                )}
              </button>
